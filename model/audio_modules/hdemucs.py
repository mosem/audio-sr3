...
from model.audio_modules.utils import capture_init, unfold
from model.audio_modules.spec import spectro, ispectro
...
class HDemucs(nn.Module):
    ...
    def forward(self, mix, time):
        ...
        # S = len(self.sources) # TODO adapt to out channels
